...
import com.clj.fastble.exception.DisconnectedException;
...
public class BleManager {
    ...
    private static final int DEFAULT_MAX_MULTIPLE_DEVICE = 10;
...
//            callback.onNotifyFailure(new OtherException("This device not connected!"));
            callback.onNotifyFailure(new DisconnectedException());
        } else {
    ...
    public void indicate(BleDevice bleDevice,
        ...
        BleBluetooth bleBluetooth = multipleBluetoothController.getBleBluetooth(bleDevice);
        if (bleBluetooth == null) {
            callback.onIndicateFailure(new DisconnectedException());
//            callback.onIndicateFailure(new OtherException("This device not connected!"));
        } else {
            bleBluetooth.newBleConnector()
    ...
    public void write(BleDevice bleDevice,
        ...
        BleBluetooth bleBluetooth = multipleBluetoothController.getBleBluetooth(bleDevice);
        if (bleBluetooth == null) {
            callback.onWriteFailure(new DisconnectedException());
//            callback.onWriteFailure(new OtherException("This device not connected!"));
        } else {
    ...
    public void read(BleDevice bleDevice,
        ...
        BleBluetooth bleBluetooth = multipleBluetoothController.getBleBluetooth(bleDevice);
        if (bleBluetooth == null) {
            callback.onReadFailure(new DisconnectedException());
//            callback.onReadFailure(new OtherException("This device is not connected!"));
    ...
    public void readRssi(BleDevice bleDevice,
        ...
        BleBluetooth bleBluetooth = multipleBluetoothController.getBleBluetooth(bleDevice);
        if (bleBluetooth == null) {
            callback.onRssiFailure(new DisconnectedException());
//            callback.onRssiFailure(new OtherException("This device is not connected!"));
    ...
    public void setMtu(BleDevice bleDevice,
        ...
        BleBluetooth bleBluetooth = multipleBluetoothController.getBleBluetooth(bleDevice);
        if (bleBluetooth == null) {
            callback.onSetMTUFailure(new DisconnectedException());
