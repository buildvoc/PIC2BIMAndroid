...
import com.erasmicoin.euspa.gsa.egnss4all.model.pathTrack.PTDao;
...
public abstract class AppDatabase extends RoomDatabase {
    ...
    private static final String TAG = "AppDatabaseEGNSS4ALL";
    ...
    public static final Migration MIGRATION_51_52 = new Migration(51, 52) {
        ...
        public void migrate(@NonNull SupportSQLiteDatabase database) {
            try{
                database.execSQL("alter table Photo add `osnmaValidated` INTEGER NOT NULL default 0");
                database.execSQL("alter table Photo add `validatedSats` INTEGER NOT NULL default 0");

            }catch(SQLiteException e){
                Log.e(TAG, "Error during migration 51 - 52 column maybe already present");
            }
    ...
    public static final Migration MIGRATION_52_53 = new Migration(52, 53) {
        @Override
        public void migrate(@NonNull SupportSQLiteDatabase database) {
            database.execSQL("alter table Photo add `inavMessages` TEXT default null");
        }
    };
    ...
    public static final Migration MIGRATION_53_54 = new Migration(53, 54) {
        @Override
        public void migrate(@NonNull SupportSQLiteDatabase database) {
            database.execSQL("alter table Photo add `provider` TEXT default null");
            database.execSQL("alter table Photo add `osnmaEnabled` INTEGER default 0");
        }
    };
    ...
    public static AppDatabase build(Context applicationContext) {
        return Room.databaseBuilder(applicationContext, AppDatabase.class, "database-name").allowMainThreadQueries().
                addMigrations(MIGRATION_42_43, MIGRATION_43_44, MIGRATION_44_45, MIGRATION_45_46, MIGRATION_46_47, MIGRATION_47_48, MIGRATION_48_49, MIGRATION_49_50, MIGRATION_50_51, MIGRATION_51_52, MIGRATION_52_53, MIGRATION_53_54)
                .build();
    }
