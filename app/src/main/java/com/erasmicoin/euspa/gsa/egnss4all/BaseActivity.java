...
import com.erasmicoin.euspa.gsa.egnss4all.MainService.BROADCAST_MSG;
import com.erasmicoin.euspa.gsa.egnss4all.MainService.BROADCAST_REFRESH_TASKS_PARAMS;
import com.erasmicoin.euspa.gsa.egnss4all.model.FileLogger;
...
public abstract class BaseActivity extends AppCompatActivity implements ServiceInit {
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) {
        ...
        if (itemId == R.id.menuItem_syncAll) {
            MS.syncAll();
            return true;
        } else if (itemId == R.id.menuItem_home) {
            showHome();
            return true;
        } else if (itemId == R.id.menuItem_taskOverview) {
            showTaskOverView();
            return true;
        } else if (itemId == R.id.menuItem_unownedPhoto) {
            showUnownedPhoto();
            return true;
        } else if (itemId == R.id.menuItem_map) {
            showMap();
            return true;
        } else if (itemId == R.id.menuItem_pathTracking) {
            showPathTracking();
            return true;
            ...
            showSettings();
            return true;
        } else if (itemId == R.id.menuItem_gnssRawData) {
            showGnssRawData();
            return true;
        } else if (itemId == R.id.menuItem_gnssSkyview) {
            showGnssSkyview();
            return true;
        }
