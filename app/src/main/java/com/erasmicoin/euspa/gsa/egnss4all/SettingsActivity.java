...
public class SettingsActivity extends BaseActivity {
    ...
    public static final boolean OSNMA_VALIDATED_DEFAULT = true;
    ...
    public void showGNSSLocationSettings(View view){
        Intent intent = new Intent(this, SettingsGNSSLocationActivity.class);
        startActivity(intent);
    }

    public void showBluetoothSettings(View view){
    ...
    private void init() {
        ...
        initOSNMAValidatedItem();
    }

    private void initOSNMAValidatedItem(){

        Switch validatedSwitch = findViewById(R.id.se_switch_buttonOSNMA);
        validatedSwitch.setChecked(PersistData.getOSNMAValidated(this));
        validatedSwitch.setOnCheckedChangeListener((buttonView, isChecked) -> {
            PersistData.saveOSNMAValidated(this, isChecked);
        });
    ...
    public void switchOSNMAValidation(View view){

        Switch aSwitch = findViewById(R.id.se_switch_buttonOSNMA);
        aSwitch.performClick();
        PersistData.saveOSNMAValidated(this, aSwitch.isChecked());
    }
