...
public class MainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            ...
            getSupportActionBar().setLogo(R.drawable.pic2bim_logo_white);
        }
        setShowMenu(true);
        resolveShowingLoggedUser();

        findViewById(R.id.buttonShowInfo).setOnClickListener(v -> {
            findViewById(R.id.landingContainer).setVisibility(View.GONE);
            findViewById(R.id.oldInfoView).setVisibility(View.VISIBLE);
        });
