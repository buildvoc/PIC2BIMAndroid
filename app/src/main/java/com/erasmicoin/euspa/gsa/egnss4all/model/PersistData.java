...
import com.erasmicoin.euspa.gsa.egnss4all.SettingFilterActivity;
import com.erasmicoin.euspa.gsa.egnss4all.SettingsActivity;
...
public class PersistData {
    ...
    private static final String SHARED_PREFERENCES_ID = "EGNSS4ALLPerzData";
    public static final String SHARED_PREFERENCES_TASK_FILTER_ID = "EGNSS4ALLPerzDataTaskFilter";
    ...
    public static void saveOSNMAValidated(Context context, boolean validated){
        SharedPreferences.Editor editor = getEditor(context);
        editor.putBoolean(PREFERENCES.OSNMA_VALIDATED.ID, validated);
        editor.apply();
    }

    public static boolean getOSNMAValidated(Context context){
        SharedPreferences sharedPreferences = getSharedPreferences(context);
        return sharedPreferences.getBoolean(PREFERENCES.OSNMA_VALIDATED.ID, SettingsActivity.OSNMA_VALIDATED_DEFAULT);
    }
